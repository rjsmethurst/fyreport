...
In this investigation we utilise visual classifications of galaxy morphologies from the Galaxy Zoo 2\footnote{\url{http://zoo2.galaxyzoo.org/}} citizen science project \citep{GZ2}; for which the full question tree for each image is shown in Figure 1 of \citet{GZ2}.  Specifically, the Galaxy Zoo 2 \cite[{GZ2} project consists of $304, 022$ images from the SDSS DR8 (a subset of those classified in Galaxy Zoo 1; GZ1) all classified by \emph{at least} 17 independent users, with the mean number of classifications standing at $\sim42$. The GZ2 project provides much more detailed classifications than the GZ1 project, allowing for further investigation of specific galaxy classes in the future with this investigation (see Section \ref{thesis}). 
